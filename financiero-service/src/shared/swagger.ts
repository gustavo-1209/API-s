export const swaggerSpec = {
  ...
  paths: {
    '/api/v1/gustavobenalcazar/pagos': {
      get: {
        tags: ['Pagos'],
    ...
    '/api/v1/gustavobenalcazar/pagos/{id}': {
      get: {
        tags: ['Pagos'],
    ...
    '/api/v1/gustavobenalcazar/facturas': {
      get: {
        tags: ['Facturas'],
    ...
    '/api/v1/gustavobenalcazar/facturas/{id}': {
      get: {
        tags: ['Facturas'],
    ...
    // ── Booking Integration ─────────────────────────────────────────────────
    '/api/v1/gustavobenalcazar/payment/booking/{reservaId}': {
      get: {
