...
app.use('/api/v1/gustavobenalcazar/payment/booking', createPaymentBookingRouter(pagoRepository));

app.use('/api/v1/gustavobenalcazar/pagos',    createPagoRouter(pagoController));
app.use('/api/v1/gustavobenalcazar/facturas', createFacturaRouter(facturaController));
