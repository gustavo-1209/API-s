export const swaggerSpec = {
  ...
  paths: {
    '/api/v1/gustavobenalcazar/reservas': {
      get: {
        tags: ['Reservas'],
    ...
    '/api/v1/gustavobenalcazar/reservas/{id}': {
      get: {
        tags: ['Reservas'],
    ...
    '/api/v1/gustavobenalcazar/reservas/{id}/cancel': {
      post: {
        tags: ['Reservas'],
    ...
    '/api/v1/gustavobenalcazar/alquileres': {
      get: {
        tags: ['Alquileres'],
    ...
    '/api/v1/gustavobenalcazar/alquileres/{id}': {
      get: {
        tags: ['Alquileres'],
    ...
    '/api/v1/gustavobenalcazar/alquileres/{id}/devolucion': {
      post: {
        tags: ['Alquileres'],
    ...
    '/api/v1/gustavobenalcazar/seguros/{id}': {
      put: {
        tags: ['Catálogos Ops'],
    ...
    '/api/v1/gustavobenalcazar/reservas/booking/{id}': {
      get: {
        tags: ['Booking Integration'],
