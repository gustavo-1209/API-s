export const swaggerSpec = {
  ...
  paths: {
    '/api/v1/gustavobenalcazar/empresas': {
      get: {
        tags: ['Empresas'],
    ...
    '/api/v1/gustavobenalcazar/empresas/{id}': {
      get: {
        tags: ['Empresas'],
    ...
    '/api/v1/gustavobenalcazar/agencias': {
      get: {
        tags: ['Agencias'],
    ...
    '/api/v1/gustavobenalcazar/agencias/{id}': {
      get: {
        tags: ['Agencias'],
    ...
    '/api/v1/gustavobenalcazar/provincias': {
      get: {
        tags: ['Ubicaciones'],
    ...
    '/api/v1/gustavobenalcazar/ciudades': {
      get: {
        tags: ['Ubicaciones'],
