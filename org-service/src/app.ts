...
app.use('/api/v1/gustavobenalcazar', createOrganizacionRouter(organizacionController));
app.use('/api/v1/gustavobenalcazar', createUbicacionRouter(ubicacionController));
