export const swaggerSpec = {
  ...
  paths: {
    '/api/v1/gustavobenalcazar/vehiculos': {
      get: {
        tags: ['Vehículos'],
    ...
    '/api/v1/gustavobenalcazar/vehiculos/{id}': {
      get: {
        tags: ['Vehículos'],
    ...
    '/api/v1/gustavobenalcazar/marcas': {
      get: {
        tags: ['Catálogos'],
    ...
    '/api/v1/gustavobenalcazar/marcas/{id}': {
      put: {
        tags: ['Catálogos'],
    ...
    '/api/v1/gustavobenalcazar/modelos': {
      get: {
        tags: ['Catálogos'],
    ...
    '/api/v1/gustavobenalcazar/categorias': {
      get: {
        tags: ['Catálogos'],
    ...
    '/api/v1/gustavobenalcazar/extras': {
      get: {
        tags: ['Catálogos'],
    ...
    '/api/v1/gustavobenalcazar/tipos-combustible': {
      get: {
        tags: ['Catálogos'],
    ...
    '/api/v1/gustavobenalcazar/tipos-transmision': {
      get: {
        tags: ['Catálogos'],
    ...
    '/api/v1/gustavobenalcazar/vehiculos/booking/{id}': {
      get: {
        tags: ['Booking Integration'],
    ...
    '/api/v1/gustavobenalcazar/vehiculos/booking/{id}/disponibilidad': {
      get: {
        tags: ['Booking Integration'],
