export const swaggerSpec = {
  ...
  paths: {
    '/api/v1/gustavobenalcazar/mantenimientos': {
      get: {
        tags: ['Mantenimientos'],
    ...
    '/api/v1/gustavobenalcazar/mantenimientos/{id}': {
      get: {
        tags: ['Mantenimientos'],
    ...
    '/api/v1/gustavobenalcazar/kardex': {
      get: {
        tags: ['Kardex'],
    ...
    '/api/v1/gustavobenalcazar/sistemas-externos': {
      get: {
    ...
    '/api/v1/gustavobenalcazar/sistemas-externos/{id}': {
      get: {
        tags: ['Sistemas Externos'],
