...
app.use('/api/v1/gustavobenalcazar/mantenimientos',    createMantenimientoRouter(mantenimientoController));
app.use('/api/v1/gustavobenalcazar/kardex',            createKardexRouter(kardexController));
app.use('/api/v1/gustavobenalcazar/sistemas-externos', createSistemaExternoRouter(sistemaExternoController));
